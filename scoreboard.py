...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        # Display the score at the lower right of the screen
...
#    def check_previous_score(self):
#        """
#        Check if new high score is greater than previous high score
#        """
#        if GameStats.high_score()
